    ...
    <>
      <style>{`
        ...
        .bls-logo {
          ...
          animation: bls-slide-up 0.6s ease both;
        ...
        .bls-spinner {
          ...
          margin-bottom: 2rem;
          animation: bls-slide-up 0.6s 0.1s ease both;
        ...
        .bls-ring-mid {
          ...
          animation: bls-spin 0.75s cubic-bezier(0.4,0,0.2,1) infinite reverse;
        }
        .bls-dot {
        ...
        .bls-label {
          ...
          animation: bls-slide-up 0.6s 0.2s ease both, bls-blink 2s 0.8s ease-in-out infinite;
          opacity: 0; animation-fill-mode: forwards;
          z-index: 1;
        }
        .bls-progress {
      ...
      >
        ...
        <p className="bls-label">Loading predictions…</p>
